#!/usr/bin/env python3
"""Render five local snapshots of a growing and shrinking disclination loop."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=REPO_ROOT / "data_control_box" / "loop_growth_local")
