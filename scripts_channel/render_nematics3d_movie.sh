...
Examples:
  ...
  START_INDEX=0 END_INDEX=500 STEP_MOD=50 FPS=8 bash scripts_channel/render_nematics3d_movie.sh
  PYTHON_BIN=python OUTPUT_ROOT=data/movie_test OVERWRITE=1 bash scripts_channel/render_nematics3d_movie.sh
USAGE
}
