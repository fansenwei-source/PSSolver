...
FPS="${FPS:-12}"
VIDEO_NAME="${VIDEO_NAME:-nematics3d_defects_velocity.mp4}"
...
Environment variables:
  ...
  OUTPUT_ROOT   Output folder. Default: DATA_DIR/nematics3d_movie
  ...
  VIDEO_NAME    Output mp4 filename. Default: nematics3d_defects_velocity.mp4
