"""Read-only planning for the bounded Stage N.3 H100 qualification."""
...
def build_stage_n3_h100_plan(
    *,
    ...
    """Return the candidate trajectory and balanced N.2/N.3 profiles."""
    ...
    trajectory = [
        python_text,
        str(project / "Plane_beris_edwards_shadow_stage_n3.py"),
    ...
    for trial in range(1, profile_trials + 1):
        ...
        commands = {
            mode: [
                python_text,
                str(project / "benchmarks/profile_plane_shadow_stage_n3.py"),
                "--production-reference-dir",
                str(production),
                "--mode",
                mode,
    ...
    analysis = [
        python_text,
        str(project / "scripts_plane/analyze_plane_shadow_stage_n3.py"),
    ...
    analysis.extend(
        (
            ...
            expected_gpu_name,
            "--output",
            str(control / "stage_n3_qualification.json"),
        )
    )
    return {
        "schema_version": 1,
        ...
        "control_definition": "stage_n2_lazy_materialization",
        "candidate_definition": "stage_n2_plus_batched_physical_islands",
        ...
        "fixed_gates": {
            ...
            "candidate_inverse_calls_must_decrease": True,
            "candidate_materialized_component_count_must_not_increase": True,
            "minimum_batched_components": 20,
            "minimum_maximum_batch_size": 5,
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Print the Stage N.3 H100 plan")
...
__all__ = ["build_stage_n3_h100_plan", "main"]
