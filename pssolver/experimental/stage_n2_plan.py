"""Read-only planning for Stage N.2 H100 qualification."""
...
def build_stage_n2_h100_plan(
    *,
    ...
    """Return the bounded candidate trajectory and balanced A/B commands."""
    ...
    trajectory = [
        python_text,
        str(project / "Plane_beris_edwards_shadow_stage_n2.py"),
    ...
    for trial in range(1, profile_trials + 1):
        ...
        commands = {
            mode: [
                python_text,
                str(project / "benchmarks/profile_plane_shadow_stage_n2.py"),
                "--production-reference-dir",
                str(production),
                "--mode",
                mode,
    ...
    analysis = [
        python_text,
        str(project / "scripts_plane/analyze_plane_shadow_stage_n2.py"),
    ...
    analysis.extend(
        (
            ...
            expected_gpu_name,
            "--output",
            str(control / "stage_n2_qualification.json"),
        )
    )
    return {
        "schema_version": 1,
        ...
        "control_definition": "stage_n1_representation_reuse",
        "candidate_definition": "stage_n1_plus_lazy_physical_materialization",
        ...
        "fixed_gates": {
            ...
            "candidate_forward_calls_must_not_increase": True,
            "candidate_inverse_calls_must_decrease": True,
            "maximum_candidate_materializations": 32,
            "minimum_deferred_components": 20,
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Print the Stage N.2 H100 plan")
...
__all__ = ["build_stage_n2_h100_plan", "main"]
